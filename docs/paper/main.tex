...
The implementation and a substantial part of the drafting were carried out with the
assistance of an AI coding assistant (Anthropic's Claude). The author conceived the
study, directed and audited the experiments---including the pre-registered stress
test that overturned an earlier claim---and is solely responsible for all claims,
results, and remaining errors.
